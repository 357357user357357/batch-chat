...
const en = {
  ...
  "sync.continueWithGoogle": "Continue with Google",
  ...
  "sync.createAccount": "No account? Sign up with e-mail",
  "sync.registerHint": "A confirmation e-mail will be sent — if it does not arrive in a few minutes, check the Spam folder.",
  ...
  "sync.deleteAccount": "Delete account",
  "sync.deleteAccountConfirmTitle": "Delete your account?",
  "sync.deleteAccountConfirmBody": "ALL your dialogs, messages and batches will be permanently deleted on the server, and your e-mail/login freed so you can register again from zero. This cannot be undone.",
  "sync.deleteAccountDone": "Account deleted. You can register again with the same e-mail.",
